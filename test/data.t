...
Note:
   ...
   SRC
          ...
          subnet mask. For example, a.a.a.t/25 or a.a.a.t:255.255.255.128.
...
$cmd 00300 deny all from a.a.a.s/16 to any in via $pif     #RFC 1918 private
 IP
$cmd 00301 deny all from a.a.a.r/12 to any in via $pif      #RFC 1918 private
 IP
$cmd 00302 deny all from 1a.a.a.o/8 to any in via $pif         #RFC 1918 private
 IP
$cmd 00303 deny all from a.a.a.p/8 to any in via $pif        #loopback
$cmd 00304 deny all from a.a.a.o/8 to any in via $pif          #loopback
$cmd 00305 deny all from a.a.a.n/16 to any in via $pif     #DHCP auto-config
$cmd 00306 deny all from a.a.a.m/24 to any in via $pif       #reserved for doc
s
$cmd 00307 deny all from a.a.a.l/23 to any in via $pif    #Sun cluster inte
rconnect
$cmd 00308 deny all from a.a.a.k/3 to any in via $pif        #Class D & E mult
icast
...
redirect_port tcp a.a.a.j:6667 6667
redirect_port tcp a.a.a.i:80 80
...
a.a.a.h. Port Redirection
   ...
   For example, tcp a.a.a.j:2000-3000 2000-3000 would redirect all
...
a.a.a.g. Address Redirection
   ...
   a.a.a.f, a.a.a.e, and a.a.a.d are available, a.a.a.f can be
   used as the [29]natd(8) machine's external IP address, while a.a.a.e
   and a.a.a.d are forwarded back to LAN clients A and B.
...
-redirect_address a.a.a.j a.a.a.e
-redirect_address a.a.a.i a.a.a.d
...
a.a.a.c. Logging Firewall Messages
...
a.a.a.b. Building a Rule Script
...
odns="a.a.a.a"      # ISP's DNS server IP address
...
# ipfw -q add allow tcp from any to a.a.a.a 53 out via tun0 setup keep-state
# ipfw -q add 00611 allow udp from any to a.a.a.a 53 out via tun0 keep-state
     __________________________________________________________________
